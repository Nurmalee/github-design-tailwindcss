...
const Repository = ({title, desc, majorLang}) => {
    return (
        <div className='p-4 mb-4 border border-solid border-gray-100 border-opacity-20 rounded-md bg-gray-800 sm:bg-transparent bg-opacity-50'>
            <h1 className='text-sm font-medium text-blue-400 mb-3 cursor-pointer hover:underline'>{title}</h1>

            <p className='text-xs text-gray-400'>{desc}</p>

            <h2 className='text-sm text-gray-400 flex items-center mt-6'> 
